...
IMAGE_DIR = BASE_DIR / "keyframes_pyscenedetect" / video_name
JSONL_PATH = BASE_DIR / 'final_input.json'
...
user_request = "이미지에 대한 자막을 1문장, 20자 이내로 생성해 주세요. '~다' 형태의 단정한 말투를 사용하세요."
...
metadata = {entry["image"]: entry for entry in data}
...
# === 결과 저장 ===
with open(BASE_DIR / "caption_candidates.json", "w", encoding="utf-8") as f:
